...
- `proxied-claude` — 99-line thin launcher: reads active profile → fetches Keychain password → `exec claude`
- `claude-proxy` — all management logic: profiles, proxies, migration, lock (~1000 lines)
